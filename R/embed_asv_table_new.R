...
#########################################################################################################################
#########################################################################################################################
#Embedding multiomics 16s
setwd("C:/Users/ctata/Documents/Lab/GME/")
#read in M3
seqtab <- t(read.delim("C:/Users/ctata/Documents/Lab/multiomics/data/16s/asv_table_nooutliers.txt"))
fasta_file <- "C:/Users/ctata/Documents/Lab/multiomics/data/16s/repseqs.fasta"

#read in best hits
best_hits <- read.delim("C:/Users/ctata/Documents/Lab/multiomics/data/16s/best_hits.tsv", header=FALSE)
colnames(best_hits) <- c("qseqid", "sseqid", "qseq", "sseq", "evalue", "bitscore")

embedding_file_name = "data/embed_matrices/embed_.07_100dim.txt"
embedded_seqtab <- embedSeqtab(seqtab, fasta_file, best_hits, embedding_file_name)
write.table(embedded_seqtab, "C:/Users/ctata/Documents/Lab/multiomics/data/16s/embedded_agp.txt", sep = "\t", quote = F)


#Embedding pilot 16s
setwd("C:/Users/ctata/Documents/Lab/GME/")
#read in M3
seqtab <- t(read.delim("C:/Users/ctata/Documents/Lab/Microbiome_ASD_16S/Microbiome_ASD_16S/data/asv_table_deseq_filt.txt"))
colnames(seqtab) <- paste('seq', seq(1, ncol(seqtab)), sep = "")
print(dim(seqtab)) #should be sample by taxa
fasta_file <- "C:/Users/ctata/Documents/Lab/Microbiome_ASD_16S/Microbiome_ASD_16S/data/repseqs.fasta"

#read in best hits
best_hits <- read.delim("C:/Users/ctata/Documents/Lab/Microbiome_ASD_16S/Microbiome_ASD_16S/embeddings/best_hits.tsv", header=FALSE)
colnames(best_hits) <- c("qseqid", "sseqid", "qseq", "sseq", "evalue", "bitscore")

embedding_file_name = "data/embed_matrices/embed_.07_100dim.txt"
embedded_seqtab <- embedSeqtab(seqtab, fasta_file, best_hits, embedding_file_name)
rownames(embedded_seqtab) <- gsub("X", "", rownames(embedded_seqtab))
write.table(embedded_seqtab, "C:/Users/ctata/Documents/Lab/Microbiome_ASD_16S/Microbiome_ASD_16S/data/embedded_agp.txt", sep = "\t", quote = F)
